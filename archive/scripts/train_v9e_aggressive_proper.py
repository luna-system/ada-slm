...
# CRITICAL: Set GPU visibility BEFORE importing torch to avoid DataParallel issues
os.environ["HIP_VISIBLE_DEVICES"] = "0"  # Single GPU for ROCm
os.environ["CUDA_VISIBLE_DEVICES"] = "0"  # In case it's CUDA
...
class TrainingConfig:
    """V9E Capacity Test configuration - DOUBLED LORA RANK!"""
    # Model
...
def train_v9e_capacity(config: TrainingConfig):
    """Run V9E Capacity Test training."""
    print("=" * 60)
    print("🧠 V9E CAPACITY TEST - Doubled LoRA Rank!")
    print("=" * 60)
    ...
    training_args = TrainingArguments(
        ...
        report_to="none",
        run_name=f"v9e_capacity_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
    ...
    # Train!
    print("\n" + "=" * 60)
    print("🚀 Starting V9E Capacity Test training...")
    print("=" * 60)
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("✅ V9E Capacity Test complete!")
        print("=" * 60)
        ...
        summary = {
            ...
            "comparison": {
                "v9b_loss": 0.785,
                "v9e_loss": train_result.training_loss,
                "delta": train_result.training_loss - 0.785,
...
def main():
    ...
    parser = argparse.ArgumentParser(description="V9E Capacity Test Training")
    ...
    success, final_loss = train_v9e_capacity(config)
    ...
    if success:
        ...
        print("\nNext steps:")
        print("  1. Test: python test_v9b_multilang.py --model v9e --languages english agl")
