...
class TrainingConfig:
    ...
    # Output
    output_dir: str = "exports/v9c_capacity"
...
def train_v9c_capacity(config: TrainingConfig):
    """Run V9C Capacity Test training."""
    print("=" * 60)
    print("🧠 V9C CAPACITY TEST - Doubled LoRA Rank!")
    print("=" * 60)
    ...
    training_args = TrainingArguments(
        ...
        report_to="none",
        run_name=f"v9c_capacity_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
...
def main():
    ...
    parser.add_argument("--output", type=str, default="exports/v9c_capacity", help="Output directory")
    ...
    success, final_loss = train_v9c_capacity(config)
