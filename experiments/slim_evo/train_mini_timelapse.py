#!/usr/bin/env python3
"""
SLIM-EVO MINI-LAB: Time-Lapse Training (High Granularity) [MANUAL LOOP VERSION]
===============================================================================

Trains the 350M model while saving a checkpoint at EVERY EPOCH
to enable high-resolution trajectory mapping.

Phase 1: Resonance (Ag) - 5 Epochs
Phase 2: Bimodal (Bi) - 5 Epochs

Total Checkpoints: 10 + Base = 11 Timepoints.
"""
...
OUTPUT_DIR = "models/mini-lab-timelapse"
DATA_RES = "data/mini_resonance.jsonl"
DATA_BI = "data/mini_bimodal.jsonl"
SEQ_LEN = 512
BATCH_SIZE = 4
LR = 5e-4
...
def main():
    ...
    # 4. Phase 2 Loop (Same Model/Adapter)
    for e in range(1, 6):
        train_one_epoch(model, tokenizer, DATA_BI, "bimodal", e)
        
    logger.info("✅ Time-Lapse Complete")
